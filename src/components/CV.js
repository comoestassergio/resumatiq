...
const CV = () => {
    return (
        <div className="min-h-screen bg-base-100 py-5 px-7 lg:max-w-5xl lg:mx-auto">
            <div className="mb-4 relative after:absolute after:w-full after:bg-slate-400 after:h-0.5">
                <h1 className="text-5xl font-bold">John Doe</h1>
                <h3 className="text-lg uppercase text-slate-600">Title</h3>
            </div>
            <div className="flex flex-row gap-3 flex-wrap">
                ...
                <p className="flex gap-2 items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                        <g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" stroke-width="1.3">
            ...
            <div className="grid grid-cols-2 mt-8 gap-x-10 gap-y-2">
                <section className="flex flex-col gap-2 row-span-2">
                    ...
                    <div className="flex flex-col gap-1 border-2 border-solid border-gray-300 rounded-lg p-5">
                        <p className="text-xl uppercase text-gray-600">Position</p>
                        <p className="text-lg font-bold">Workplace</p>
                ...
                <section>
                    ...
                    <ul className="flex flex-row gap-3 pt-5 flex-wrap">
                        <li className="border-2 border-gray-300 capitalize px-5 py-2 rounded-lg">Skill</li>
                        <li className="border-2 border-gray-300 capitalize px-5 py-2 rounded-lg">Skill</li>
                        <li className="border-2 border-gray-300 capitalize px-5 py-2 rounded-lg">Skill</li>
                        <li className="border-2 border-gray-300 capitalize px-5 py-2 rounded-lg">Skill</li>
                        <li className="border-2 border-gray-300 capitalize px-5 py-2 rounded-lg">Skill</li>
                ...
                <section>
                    ...
                    <div className="flex flex-col gap-1 border-2 border-gray-300 rounded-lg p-5">
                        <p className="text-xl uppercase text-gray-600">University</p>
                        <p className="text-lg capitalize font-bold">Degree</p>
                        <p className="flex gap-2 text-sm items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5" />
                            </svg>
