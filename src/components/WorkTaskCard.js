...
const WorkTaskCard = ({ text, setTaskEntry, taskEntry, card }) => {
    ...
    return (
        <li 
        className="px-4 py-2 border-solid border-2 rounded-lg w-80 md:w-96 border-gray-300 text-gray-600 bg-base-200 flex items-center justify-between gap-1 capitalize"
        >
